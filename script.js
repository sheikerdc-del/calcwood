...
const calculators = [
  { id:'glue', name:'Калькулятор клея', url:'https://calcul-klei.onrender.com', desc:'Подбор количества клея, раствора для работ с плиткой, керамогранитом и кирпичом.', cover:'./covers/glue.webp' },
  { id:'fcs', name:'Калькулятор ФКС', url:'https://calc-fcs.onrender.com', desc:'Расчеты крепежа и клямеров для фиброцементного сайдинга.', cover:'./covers/fcs.webp' },
